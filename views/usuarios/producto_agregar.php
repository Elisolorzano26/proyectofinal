...
<div class="col-sm-6">
<div class="mb-3">
<label for="descripcion" class="form-label">Codigo de barras *</label>
<input type="text"  id="cbarras" name="cbarras" class="form-control" required >
</div>
</div>
</div>
...
<select name="categorias" id="categorias" class="form-control" required>
    ...
    <option value="ferreteria">Area Ferretera</option>
    <option value="plomeria">Plomeria</option>
    <option value="topografia">Herramienta de topografia</option>
